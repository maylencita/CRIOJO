...
//  }
  ...
  def notTest(){
    ...
    val expected = "{(z=6) ^ (x!=2,y!=2)^(x!=6,y!=6)},{(z=5) ^ (x!=2,y!=2)^(x!=6,y!=6)},{T ^ (x!=2,y!=2)^(x!=3,y!=4)^(x!=6,y!=6)}" +
      ",{(z=4) ^ (x!=2,y!=2)^(x!=3,y!=4)},{(z=3) ^ (x!=2,y!=2)^(x!=3,y!=4)},{(z=3) ^ (x!=3,y!=4)^(x!=6,y!=6)}" +
      ",{(z=3) ^ (x!=3,y!=4)},{(z=4) ^ (x!=3,y!=4)^(x!=6,y!=6)},{(z=4) ^ (x!=3,y!=4)}"
