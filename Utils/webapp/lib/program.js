...
(function() {
  var $, Controller, Events, Log, Model, Module, Spine, Task, TaskApp, Tasks, guid, isArray, isBlank, makeArray, moduleKeywords,
    __slice = [].slice,
  ...
  Model = (function(_super) {
    ...
    Model.prototype.eql = function(rec) {
      var _ref, _ref1;
      return rec && rec.constructor === this.constructor && (rec.id === this.id || (_ref = this.id, __indexOf.call(rec.ids, _ref) >= 0) || (_ref1 = rec.id, __indexOf.call(this.ids, _ref1) >= 0));
    };
  ...
  TaskApp = (function(_super) {
    ...
    TaskApp.prototype.refresh = function() {
      return this.$("#list-messages").listview("refresh");
    };
    ...
    TaskApp.prototype.addOne = function(task) {
      ...
      obj = this.items.append(view.render().el);
      this.refresh();
      return obj;
    };
