 ...
 * 
 * A Bus connector is used to connect on bus. Bus is media to interconnect many
 * Criojo Agent over network. The Bus is in charge of routing message with
 * secure and safe perspectives.
 */
public interface BusConnector {
	 ...
	 *           Troubles during sending message.
	 */
	public void send(String message, String recipientName)
	    throws BusConnectorException;

	/**
	 * Broadcast message to all recipient.
	 * 
	 * @param message
	 *          The message to send to all recipient.
	 * @throws BusConnectorException
	 *           Troubles during sending message.
	 */
	 ...
	 *          A ReceiveHandler.
	 * @throws BusConnectorException
	 *           Troubles during setting handler.
	 */
