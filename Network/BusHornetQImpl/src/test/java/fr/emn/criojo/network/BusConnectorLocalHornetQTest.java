...
public class BusConnectorLocalHornetQTest {
  ...
  public void localSendTest() {
    ...
    try {
      ...
      final String[] REQUIRED_PROPS = { "localSendTest.busNodePort.1",
          "localSendTest.connectorName.1", "localSendTest.connectorLogin.1",
          "localSendTest.connectorPassword.1", "localSendTest.busNodePort.2",
          "localSendTest.connectorName.2", "localSendTest.connectorLogin.2",
  ...
  public void localBroadcastTest() {
    try {
      ...
      final String CONNECTOR_LOGIN_3 = testProps
          .getProperty(REQUIRED_PROPS[10]);
